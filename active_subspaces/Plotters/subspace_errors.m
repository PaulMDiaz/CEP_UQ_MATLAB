function F1 =  subspace_errors(sub_br, varargin)
...
if isempty(opts.xlabel)
    xlabel('Subspace dimension $n$', 'fontsize', opts.fontsize,'interpreter','latex')
else
    xlabel(opts.xlabel, 'fontsize', opts.fontsize)
end

if isempty(opts.ylabel)
    ylabel('Subspace Error $e_{as}$', 'fontsize', opts.fontsize,'interpreter','latex')
else
